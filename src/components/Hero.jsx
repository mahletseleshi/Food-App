  ...
  return (
    <div className="max-w-[1640px]">
        <div className="w-full h-[550px] relative">
            <div className="text-3xl sm:text-4xl md:text-5xl flex flex-col justify-center p-8 px-12 text-white font-bold lg:text-6xl absolute w-full h-[550px] bg-black/50 ">
